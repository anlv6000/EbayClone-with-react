            ...
            React.createElement(CardContent, null,
                React.createElement("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-4" },
                    ...
                    React.createElement("div", { className: "space-y-2" },
                        ...
                        React.createElement(RadioGroup, { defaultValue: "buyer" },
                            React.createElement("div", { className: "flex items-center space-x-2" },
                                React.createElement(RadioGroupItem, Object.assign({ value: "buyer", id: "buyer" }, register("role"))),
                                React.createElement(Label, { htmlFor: "buyer" }, "I want to shop")),
                            React.createElement("div", { className: "flex items-center space-x-2" },
                                React.createElement(RadioGroupItem, Object.assign({ value: "seller", id: "seller" }, register("role"))),
                                React.createElement(Label, { htmlFor: "seller" }, "I want to sell"))),
